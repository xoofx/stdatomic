...
*** The =__atomic_= ABI
   ...
   operations
     - =fetch_add= for integer addition
     - =fetch_sub= for integer substraction
   ...
   or =__GCC_HAVE_SYNC_COMPARE_AND_SWAP_X= exist. If so we assume that
   =__uint128_t= is such an integer type.
