...
base = "test-pthread"
#files = "test-16b test-futex-1 test-futex-2 test-futex-4 test-musl test-musl-orl test-cmpxchg test-pthread"
files = "test-futex-1 test-futex-2 test-futex-4 test-musl test-musl-orl test-cmpxchg test-pthread"
set for [i = 1:10] style line i lw 4
set style line 6 lc rgb "red"
set style increment userstyles
plot for [file in files] sprintf("< paste %s.dat %s.dat", file, base) using 1:($2/$6) with lines title sprintf("%s", file[6:])
#    EOF
