...
set output 'test-spin-shortcut-relative.eps'
unset clip points
set clip one
unset clip two
...
set title "musl, stress test on lock primitives, different __wait implementations" 
...
files = "test-16b-no-shortcut test-16b-shortcut test-16b-spin0"
set for [i = 1:10] style line i lw 4
set style line 6 lc rgb "red"
set style increment userstyles
plot for [file in files] sprintf("< paste %s.dat %s.dat", file, base) using 1:($2/$6) with lines title sprintf("%s", file[10:])
#    EOF
