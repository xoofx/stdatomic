...
base = "glibc-native"
files = "glibc-native glibc-futex glibc-musl glibc-mtx glibc-repl"
set for [i = 1:10] style line i lw 4
set style line 6 lc rgb "red"
set style increment userstyles
plot for [file in files] sprintf("< paste test-%s.dat test-%s.dat", file, base) using 1:($2) with lines title sprintf("%s", file[7:])
#    EOF
