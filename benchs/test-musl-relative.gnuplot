...
set output 'test-musl-relative.eps'
unset clip points
set clip one
unset clip two
...
set title "musl, stress test on lock primitives, different a_store implementations" 
...
base = "test-musl-mfence"
files = "test-musl-xchg test-musl-orl-esp test-musl-mfence"
