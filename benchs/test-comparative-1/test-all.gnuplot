...
set yrange [ 1E6 : 1E7 ] noreverse nowriteback
...
plot                                                                                             \
     "./test-16b.dat" with lines title "16 byte instruction",             \
     "./test-futex-2.dat" with lines title "futex lock 2",                   \
     "./test-musl.dat" with lines title "musl lock",                           \
     "./test-musl-orl.dat" with lines title "musl lock (orl)",                           \
     "./test-pthread.dat" with lines title "pthread_mutex_t",                  \
     "./test-cmpxchg.dat" with lines title "atomic_compare_exchange"
#    EOF
